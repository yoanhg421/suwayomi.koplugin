...
describe("suwayomi plugin", function()
    ...
    it("adds the plugin as a top tab with the Suwayomi actions", function()
        ...
        assert.is_function(menu_items.suwayomi_open.text_func)
        assert.are.equal("Open", menu_items.suwayomi_open.text_func())
        assert.are.equal("suwayomi_tab", menu_items.suwayomi_open.sorting_hint)
        assert.is_function(menu_items.suwayomi_open.callback)
        assert.is_function(menu_items.suwayomi_sync.enabled_func)
    ...
    it("opens the Suwayomi library from the top tab", function()
        local menu_items = {}
        local plugin = build_plugin()
